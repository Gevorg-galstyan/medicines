...
@section('page_title', ((!is_null($data->getKey()) ? 'edit' : 'add' ) .  'Type'))

@section('page_header')
    <h1 class="page-title">
        {{ ((!is_null($data->getKey()) ? 'Edit ' : 'Add ' ) .  'Type') }}
    </h1>
@stop
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                          class="form-edit-add"
                          action="{{!is_null($data->getKey()) ? route('type.update', $data->id)  : route('type.store')}}"
